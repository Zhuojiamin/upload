<!--<?php print <<<EOT
-->
<html><head><title>LxBlog Installation</title>
...
<span style="COLOR: #cc0000">&gt;&gt;</span> LxBlog Installation 
...
$value = str_replace(array(R_P,D_P),'',$value);print <<<EOT
-->
$value<br>
<!--  
EOT;
...
if(!$check){print <<<EOT
-->
<tr><td class='i' colspan='2' align='center'><input onclick='history.go(-1)' type='button' value='$lang[error_back]'><br><br><br></td></tr>
<!--
EOT;
}else{print <<<EOT
-->
...
<tr><td class='i' colspan='2' align='left'></tr>
<tr><td class='i' colspan='2' align='center'><input onclick='history.go(-1)' type='button' value='$lang[error_back]'><br><br></td></tr>
<!--
EOT;
}else{print <<<EOT
-->
...
<tr><td align=left class=r align=middle colSpan=2>&nbsp;&nbsp;$lang[write_success]</td></tr>
<tr><td class='i' colspan='2' align='left'><span style='color:#CC0000'>&gt;</span>&nbsp;$lang[admin_name]</td></tr>
<tr><td class='t' width='50%'>$lang[show_admin]</td></tr>
<!--
EOT;
if($D_exists){print <<<EOT
-->
<tr><td class='i' colspan='2' align='left'><br><hr align="center" width="99%" size="1" color=#9999cc>
<span style='color:#CC0000'>&gt;</span>&nbsp;$lang[msg_info]</td></tr>
<tr><td class='t' width='50%'><br>$lang[have_install]</td></tr>
<tr><td class='t' align='center' width='50%'><br><br><input type='submit' value='$lang[goon]' onclick="return checkset('$lang[install_confirm]')">
<!--
EOT;
}else{print <<<EOT
-->
<tr><td class='t' align='center' width='50%'><br><br><input type='submit' value='$lang[goon]'>
<!--
EOT;
}print <<<EOT
-->
...
<td class='t'><input type='text' name='blogurl' value='$blogurl' size=30></td></tr>
</table>
</td></tr>
</table>
<br><br></td></tr>
...
<img src=" http://nt.phpwind.com/src/install_stats.php?url=$B_url&version=$wind_version&type=blog&charsets=$charset&c=0" width="0" height="0">
<!--
EOT;
}elseif($step==5){print <<<EOT
-->
<tr><td class='i' width='50%'><span style='color:#CC0000'>&gt;</span><a href='admin.php'>$lang[enter_blog]</a><br><br></td></tr>
$unlinkerror
<!--
EOT;
}print <<<EOT
